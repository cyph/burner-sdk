...
class Cyph {
	...
	static function generateLink($options, $services) {
		...
		return _hx_anonymous(array("id" => $id, "link" => _hx_string_or_null($tmp) . _hx_string_or_null($tmp1) . _hx_string_or_null($tmp2) . _hx_string_or_null($id) . _hx_string_or_null(Cyph::generateGuid(19))));
	}
...
Cyph::$services = _hx_anonymous(array("backend" => "https://api.cyph.com", "chat" => "https://cyph.im/#", "telehealth" => "https://video.cyph.healthcare/#", "video" => "https://cyph.video/#", "voice" => "https://cyph.audio/#"));
