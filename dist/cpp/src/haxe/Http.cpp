...
::haxe::Http Http_obj::setHeader( ::String header,::String value){
	HX_STACK_FRAME("haxe.Http","setHeader",0x34bd0dd1,"haxe.Http.setHeader","/usr/share/haxe/std/haxe/Http.hx",110,0x6694f828)
	HX_STACK_THIS(this)
	...
	bool run(Dynamic h){
		HX_STACK_FRAME("*","_Function_1_1",0x5200ed37,"*._Function_1_1","/usr/share/haxe/std/haxe/Http.hx",111,0x6694f828)
		HX_STACK_ARG(h,"h")
		{
			HX_STACK_LINE(111)
	...
	struct _Function_1_2{
		inline static Dynamic Block( ::String &header,::String &value){
			HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","/usr/share/haxe/std/haxe/Http.hx",112,0x6694f828)
			{
...
::haxe::Http Http_obj::setParameter( ::String param,::String value){
	HX_STACK_FRAME("haxe.Http","setParameter",0x96e033e5,"haxe.Http.setParameter","/usr/share/haxe/std/haxe/Http.hx",128,0x6694f828)
	HX_STACK_THIS(this)
	...
	int __ArgCount() const { return 1; }
	bool run(Dynamic p){
		HX_STACK_FRAME("*","_Function_1_1",0x5200ed37,"*._Function_1_1","/usr/share/haxe/std/haxe/Http.hx",129,0x6694f828)
		HX_STACK_ARG(p,"p")
		{
			HX_STACK_LINE(129)
	...
	struct _Function_1_2{
		inline static Dynamic Block( ::String &param,::String &value){
			HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","/usr/share/haxe/std/haxe/Http.hx",130,0x6694f828)
			{
				hx::Anon __result = hx::Anon_obj::Create();
...
::haxe::Http Http_obj::setPostData( ::String data){
	HX_STACK_FRAME("haxe.Http","setPostData",0x64dc53ee,"haxe.Http.setPostData","/usr/share/haxe/std/haxe/Http.hx",149,0x6694f828)
	HX_STACK_THIS(this)
