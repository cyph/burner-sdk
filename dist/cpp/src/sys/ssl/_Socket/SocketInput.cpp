...
HX_DEFINE_STACK_FRAME(_hx_pos_8eb172850483f24d_13_new,"sys.ssl._Socket.SocketInput","new",0x0d9c972a,"sys.ssl._Socket.SocketInput.new","/usr/share/haxe/std/cpp/_std/sys/ssl/Socket.hx",13,0xa5745982)
HX_LOCAL_STACK_FRAME(_hx_pos_8eb172850483f24d_17_readByte,"sys.ssl._Socket.SocketInput","readByte",0xa45b5674,"sys.ssl._Socket.SocketInput.readByte","/usr/share/haxe/std/cpp/_std/sys/ssl/Socket.hx",17,0xa5745982)
HX_LOCAL_STACK_FRAME(_hx_pos_8eb172850483f24d_30_readBytes,"sys.ssl._Socket.SocketInput","readBytes",0x2b904f7f,"sys.ssl._Socket.SocketInput.readBytes","/usr/share/haxe/std/cpp/_std/sys/ssl/Socket.hx",30,0xa5745982)
HX_LOCAL_STACK_FRAME(_hx_pos_8eb172850483f24d_48_close,"sys.ssl._Socket.SocketInput","close",0xce82a502,"sys.ssl._Socket.SocketInput.close","/usr/share/haxe/std/cpp/_std/sys/ssl/Socket.hx",48,0xa5745982)
namespace sys{
namespace ssl{
namespace _Socket{

void SocketInput_obj::__construct( ::sys::ssl::Socket s){
            	HX_STACKFRAME(&_hx_pos_8eb172850483f24d_13_new)
...
int SocketInput_obj::readByte(){
            	HX_GC_STACKFRAME(&_hx_pos_8eb172850483f24d_17_readByte)
HXLINE(  17)		try {
...
int SocketInput_obj::readBytes( ::haxe::io::Bytes buf,int pos,int len){
            	HX_GC_STACKFRAME(&_hx_pos_8eb172850483f24d_30_readBytes)
HXLINE(  31)		int r;
...
void SocketInput_obj::close(){
            	HX_STACKFRAME(&_hx_pos_8eb172850483f24d_48_close)
