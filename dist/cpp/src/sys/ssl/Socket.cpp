...
HX_DEFINE_STACK_FRAME(_hx_pos_7b961d53d8381ba9_96_new,"sys.ssl.Socket","new",0xb0189de8,"sys.ssl.Socket.new","/usr/share/haxe/std/cpp/_std/sys/ssl/Socket.hx",96,0xa5745982)
HX_LOCAL_STACK_FRAME(_hx_pos_971ce4184a2a5127_266___init__,"::sys::ssl::Socket_obj","__init__",0xb5703314,"::sys::ssl::Socket_obj.__init__","/usr/share/haxe/std/cpp/_std/sys/ssl/Socket.hx",266,0xa5745982)
HX_LOCAL_STACK_FRAME(_hx_pos_7b961d53d8381ba9_115_init,"sys.ssl.Socket","init",0x622a4488,"sys.ssl.Socket.init","/usr/share/haxe/std/cpp/_std/sys/ssl/Socket.hx",115,0xa5745982)
HX_LOCAL_STACK_FRAME(_hx_pos_7b961d53d8381ba9_129_connect,"sys.ssl.Socket","connect",0x6aae6d72,"sys.ssl.Socket.connect","/usr/share/haxe/std/cpp/_std/sys/ssl/Socket.hx",129,0xa5745982)
HX_LOCAL_STACK_FRAME(_hx_pos_7b961d53d8381ba9_151_handshake,"sys.ssl.Socket","handshake",0x5679847f,"sys.ssl.Socket.handshake","/usr/share/haxe/std/cpp/_std/sys/ssl/Socket.hx",151,0xa5745982)
HX_LOCAL_STACK_FRAME(_hx_pos_7b961d53d8381ba9_185_write,"sys.ssl.Socket","write",0x9512ac67,"sys.ssl.Socket.write","/usr/share/haxe/std/cpp/_std/sys/ssl/Socket.hx",185,0xa5745982)
HX_LOCAL_STACK_FRAME(_hx_pos_7b961d53d8381ba9_190_close,"sys.ssl.Socket","close",0x0d1c5740,"sys.ssl.Socket.close","/usr/share/haxe/std/cpp/_std/sys/ssl/Socket.hx",190,0xa5745982)
HX_LOCAL_STACK_FRAME(_hx_pos_7b961d53d8381ba9_235_buildSSLConfig,"sys.ssl.Socket","buildSSLConfig",0xf55ff618,"sys.ssl.Socket.buildSSLConfig","/usr/share/haxe/std/cpp/_std/sys/ssl/Socket.hx",235,0xa5745982)
HX_LOCAL_STACK_FRAME(_hx_pos_7b961d53d8381ba9_242_buildSSLConfig,"sys.ssl.Socket","buildSSLConfig",0xf55ff618,"sys.ssl.Socket.buildSSLConfig","/usr/share/haxe/std/cpp/_std/sys/ssl/Socket.hx",242,0xa5745982)
HX_LOCAL_STACK_FRAME(_hx_pos_7b961d53d8381ba9_98_boot,"sys.ssl.Socket","boot",0x5d8a8daa,"sys.ssl.Socket.boot","/usr/share/haxe/std/cpp/_std/sys/ssl/Socket.hx",98,0xa5745982)
namespace sys{
namespace ssl{

void Socket_obj::__construct(){
            	HX_STACKFRAME(&_hx_pos_7b961d53d8381ba9_96_new)
...
void Socket_obj::__init__(){
            	HX_STACKFRAME(&_hx_pos_971ce4184a2a5127_266___init__)
HXLINE( 266)		_hx_ssl_init();
            	}


void Socket_obj::init(){
            	HX_GC_STACKFRAME(&_hx_pos_7b961d53d8381ba9_115_init)
...
void Socket_obj::connect( ::sys::net::Host host,int port){
            	HX_STACKFRAME(&_hx_pos_7b961d53d8381ba9_129_connect)
HXLINE( 129)		try {
...
void Socket_obj::handshake(){
            	HX_STACKFRAME(&_hx_pos_7b961d53d8381ba9_151_handshake)
HXLINE( 151)		if (!(this->handshakeDone)) {
HXLINE( 152)			try {
            				HX_STACK_CATCHABLE( ::Dynamic, 0);
...
void Socket_obj::write(::String content){
            	HX_STACKFRAME(&_hx_pos_7b961d53d8381ba9_185_write)
...
void Socket_obj::close(){
            	HX_STACKFRAME(&_hx_pos_7b961d53d8381ba9_190_close)
...
HXLINE( 200)		output->close();
 ...
 ::Dynamic Socket_obj::buildSSLConfig(bool server){
            	HX_STACKFRAME(&_hx_pos_7b961d53d8381ba9_235_buildSSLConfig)
HXLINE( 235)		 ::sys::ssl::Socket _gthis = hx::ObjectPtr<OBJ_>(this);
...
HXLINE( 241)		if (hx::IsNotNull( this->altSNIContexts )) {
            			HX_BEGIN_LOCAL_FUNC_S1(hx::LocalFunc,_hx_Closure_0, ::sys::ssl::Socket,_gthis) HXARGC(1)
            			 ::Dynamic _hx_run( ::Dynamic servername){
            				HX_STACKFRAME(&_hx_pos_7b961d53d8381ba9_242_buildSSLConfig)
...
{
{
            	HX_STACKFRAME(&_hx_pos_7b961d53d8381ba9_98_boot)
