...
HX_DEFINE_STACK_FRAME(_hx_pos_6ab7e3b0439582c8_77_new,"sys.net._Socket.SocketOutput","new",0x717472d4,"sys.net._Socket.SocketOutput.new","/usr/share/haxe/std/cpp/_std/sys/net/Socket.hx",77,0xb72d4153)
HX_LOCAL_STACK_FRAME(_hx_pos_6ab7e3b0439582c8_80_writeByte,"sys.net._Socket.SocketOutput","writeByte",0xbfd704fb,"sys.net._Socket.SocketOutput.writeByte","/usr/share/haxe/std/cpp/_std/sys/net/Socket.hx",80,0xb72d4153)
HX_LOCAL_STACK_FRAME(_hx_pos_6ab7e3b0439582c8_94_writeBytes,"sys.net._Socket.SocketOutput","writeBytes",0x1c4d5718,"sys.net._Socket.SocketOutput.writeBytes","/usr/share/haxe/std/cpp/_std/sys/net/Socket.hx",94,0xb72d4153)
HX_LOCAL_STACK_FRAME(_hx_pos_6ab7e3b0439582c8_106_close,"sys.net._Socket.SocketOutput","close",0xbcc83f2c,"sys.net._Socket.SocketOutput.close","/usr/share/haxe/std/cpp/_std/sys/net/Socket.hx",106,0xb72d4153)
namespace sys{
namespace net{
namespace _Socket{

void SocketOutput_obj::__construct( ::Dynamic s){
            	HX_STACKFRAME(&_hx_pos_6ab7e3b0439582c8_77_new)
...
void SocketOutput_obj::writeByte(int c){
            	HX_STACKFRAME(&_hx_pos_6ab7e3b0439582c8_80_writeByte)
...
int SocketOutput_obj::writeBytes( ::haxe::io::Bytes buf,int pos,int len){
            	HX_GC_STACKFRAME(&_hx_pos_6ab7e3b0439582c8_94_writeBytes)
HXLINE(  94)		try {
            			HX_STACK_CATCHABLE( ::Dynamic, 0);
...
void SocketOutput_obj::close(){
            	HX_STACKFRAME(&_hx_pos_6ab7e3b0439582c8_106_close)
