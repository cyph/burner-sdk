...
HX_LOCAL_STACK_FRAME(_hx_pos_4d4623eba6a46339_135_generateLink,"Cyph","generateLink",0x533097ef,"Cyph.generateLink","Cyph.hx",135,0x050f2930)
HX_LOCAL_STACK_FRAME(_hx_pos_4d4623eba6a46339_211_initiateSession,"Cyph","initiateSession",0x9ff79fdd,"Cyph.initiateSession","Cyph.hx",211,0x050f2930)
HX_LOCAL_STACK_FRAME(_hx_pos_4d4623eba6a46339_172_initiateSession,"Cyph","initiateSession",0x9ff79fdd,"Cyph.initiateSession","Cyph.hx",172,0x050f2930)
...
STATIC_HX_DEFINE_DYNAMIC_FUNC6(Cyph_obj,request,(void))
 ...
 ::Dynamic Cyph_obj::generateLink(::Array< int > options, ::Dynamic services){
            	HX_STACKFRAME(&_hx_pos_4d4623eba6a46339_135_generateLink)
HXLINE( 136)		::String id = ::Cyph_obj::generateGuid((int)7);
HXLINE( 140)		::String _hx_tmp;
HXDLIN( 140)		if ((options->indexOf( ::Dynamic(::Cyph_obj::options->__Field(HX_("telehealth",46,e6,42,e1),hx::paccDynamic)),null()) > (int)-1)) {
HXLINE( 140)			_hx_tmp = ( (::String)(services->__Field(HX_("telehealth",46,e6,42,e1),hx::paccDynamic)) );
            		}
            		else {
HXLINE( 143)			if ((options->indexOf( ::Dynamic(::Cyph_obj::options->__Field(HX_("video",7b,14,fc,36),hx::paccDynamic)),null()) > (int)-1)) {
HXLINE( 140)				_hx_tmp = ( (::String)(services->__Field(HX_("video",7b,14,fc,36),hx::paccDynamic)) );
            			}
            			else {
HXLINE( 146)				if ((options->indexOf( ::Dynamic(::Cyph_obj::options->__Field(HX_("voice",b2,25,f7,3a),hx::paccDynamic)),null()) > (int)-1)) {
HXLINE( 140)					_hx_tmp = ( (::String)(services->__Field(HX_("voice",b2,25,f7,3a),hx::paccDynamic)) );
            				}
            				else {
HXLINE( 140)					_hx_tmp = ( (::String)(services->__Field(HX_("chat",d8,5e,bf,41),hx::paccDynamic)) );
            				}
            			}
            		}
HXLINE( 153)		::String _hx_tmp1;
HXDLIN( 153)		if ((options->indexOf( ::Dynamic(::Cyph_obj::options->__Field(HX_("modestBranding",1f,fb,4c,44),hx::paccDynamic)),null()) > (int)-1)) {
HXLINE( 153)			_hx_tmp1 = HX_("!",21,00,00,00);
            		}
            		else {
HXLINE( 153)			_hx_tmp1 = HX_("",00,00,00,00);
            		}
HXLINE( 140)		::String _hx_tmp2 = (_hx_tmp + _hx_tmp1);
HXLINE( 154)		::String _hx_tmp3;
HXDLIN( 154)		if ((options->indexOf( ::Dynamic(::Cyph_obj::options->__Field(HX_("disableP2P",46,97,a5,b6),hx::paccDynamic)),null()) > (int)-1)) {
HXLINE( 154)			_hx_tmp3 = HX_("$",24,00,00,00);
            		}
            		else {
HXLINE( 154)			_hx_tmp3 = HX_("",00,00,00,00);
            		}
HXLINE( 140)		::String _hx_tmp4 = ((_hx_tmp2 + _hx_tmp3) + id);
HXLINE( 138)		return  ::Dynamic(hx::Anon_obj::Create(2)
            			->setFixed(0,HX_("id",db,5b,00,00),id)
            			->setFixed(1,HX_("link",fa,17,b3,47),(_hx_tmp4 + ::Cyph_obj::generateGuid((int)19))));
            	}
...
void Cyph_obj::initiateSession(::String apiKey,::Array< int > options, ::Dynamic services, ::Dynamic onData, ::Dynamic onError){
            		...
            		void _hx_run(::String data){
            			HX_STACKFRAME(&_hx_pos_4d4623eba6a46339_211_initiateSession)
HXLINE( 211)			onData( ::Dynamic(linkData->__Field(HX_("link",fa,17,b3,47),hx::paccDynamic)));
            		}
            		HX_END_LOCAL_FUNC1((void))

            	HX_STACKFRAME(&_hx_pos_4d4623eba6a46339_172_initiateSession)
HXLINE( 173)		if (hx::IsNull( options )) {
HXLINE( 174)			options = ::Array_obj< int >::__new(0);
            		}
HXLINE( 182)		if (hx::IsNull( services )) {
HXLINE( 183)			services = ::Cyph_obj::services;
            		}
HXLINE( 191)		if (hx::IsNull( ( (::String)(services->__Field(HX_("backend",14,bc,87,fb),hx::paccDynamic)) ) )) {
HXLINE( 192)			services->__SetField(HX_("backend",14,bc,87,fb),( (::String)(::Cyph_obj::services->__Field(HX_("backend",14,bc,87,fb),hx::paccDynamic)) ),hx::paccDynamic);
            		}
HXLINE( 194)		if (hx::IsNull( ( (::String)(services->__Field(HX_("telehealth",46,e6,42,e1),hx::paccDynamic)) ) )) {
HXLINE( 195)			services->__SetField(HX_("telehealth",46,e6,42,e1),(( (::String)(services->__Field(HX_("chat",d8,5e,bf,41),hx::paccDynamic)) ) + HX_("video/",54,d7,95,e5)),hx::paccDynamic);
            		}
HXLINE( 197)		if (hx::IsNull( ( (::String)(services->__Field(HX_("video",7b,14,fc,36),hx::paccDynamic)) ) )) {
HXLINE( 198)			services->__SetField(HX_("video",7b,14,fc,36),(( (::String)(services->__Field(HX_("chat",d8,5e,bf,41),hx::paccDynamic)) ) + HX_("video/",54,d7,95,e5)),hx::paccDynamic);
            		}
HXLINE( 200)		if (hx::IsNull( ( (::String)(services->__Field(HX_("voice",b2,25,f7,3a),hx::paccDynamic)) ) )) {
HXLINE( 201)			services->__SetField(HX_("voice",b2,25,f7,3a),(( (::String)(services->__Field(HX_("chat",d8,5e,bf,41),hx::paccDynamic)) ) + HX_("audio/",99,42,e9,68)),hx::paccDynamic);
            		}
HXLINE( 204)		 ::Dynamic linkData = ::Cyph_obj::generateLink(options,services);
HXLINE( 206)		::Cyph_obj::request(((( (::String)(services->__Field(HX_("backend",14,bc,87,fb),hx::paccDynamic)) ) + HX_("/preauth/",f3,23,8b,ce)) + ( (::String)(linkData->__Field(HX_("id",db,5b,00,00),hx::paccDynamic)) )),true,::Array_obj< ::Dynamic>::__new(1)->init(0, ::Dynamic(hx::Anon_obj::Create(2)
...
HXDLIN(  19)		services =  ::Dynamic(hx::Anon_obj::Create(5)
            			->setFixed(0,HX_("telehealth",46,e6,42,e1),HX_("https://video.cyph.healthcare/#",5f,59,d6,d9))
            			->setFixed(1,HX_("backend",14,bc,87,fb),HX_("https://api.cyph.com",a4,ff,d4,e9))
...
HXDLIN(  27)		options =  ::Dynamic(hx::Anon_obj::Create(5)
            			->setFixed(0,HX_("disableP2P",46,97,a5,b6),(int)1)
            			->setFixed(1,HX_("telehealth",46,e6,42,e1),(int)3)
            			->setFixed(2,HX_("video",7b,14,fc,36),(int)4)
            			->setFixed(3,HX_("voice",b2,25,f7,3a),(int)5)
            			->setFixed(4,HX_("modestBranding",1f,fb,4c,44),(int)2));
            	}
}
