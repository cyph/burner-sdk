...
::String Cyph_obj::generateGuid( int length){
	HX_STACK_FRAME("Cyph","generateGuid",0x4feb9d7e,"Cyph.generateGuid","Cyph.hx",31,0x050f2930)
...
::String Cyph_obj::initiateSession( Array< int > options){
	HX_STACK_FRAME("Cyph","initiateSession",0x9ff79fdd,"Cyph.initiateSession","Cyph.hx",47,0x050f2930)
...
Dynamic run(::String s){
	HX_STACK_FRAME("*","_Function_0_1",0x52002af6,"*._Function_0_1","Cyph.hx",13,0x050f2930)
	HX_STACK_ARG(s,"s")
	{
		HX_STACK_LINE(14)
...
struct _Function_0_2{
	inline static Dynamic Block( ){
		HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","Cyph.hx",17,0x050f2930)
		{
...
struct _Function_0_3{
	inline static Dynamic Block( ){
		HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","Cyph.hx",23,0x050f2930)
		{
			hx::Anon __result = hx::Anon_obj::Create();
