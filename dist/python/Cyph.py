...
class Cyph:
    ...
    def generateLink(options = None,services = None):
        ...
        return _hx_AnonObject({'id': id, 'link': (((((HxOverrides.stringOrNull(((services.video if ((python_internal_ArrayImpl.indexOf(options,Cyph.options.video,None) > -1)) else (services.voice if ((python_internal_ArrayImpl.indexOf(options,Cyph.options.voice,None) > -1)) else services.chat)))) + HxOverrides.stringOrNull((("&" if ((python_internal_ArrayImpl.indexOf(options,Cyph.options.modestBranding,None) > -1)) else "")))) + HxOverrides.stringOrNull((("$" if ((python_internal_ArrayImpl.indexOf(options,Cyph.options.disableP2P,None) > -1)) else "")))) + HxOverrides.stringOrNull((("%" if ((python_internal_ArrayImpl.indexOf(options,Cyph.options.nativeCrypto,None) > -1)) else "")))) + ("null" if id is None else id)) + HxOverrides.stringOrNull(Cyph.generateGuid(19)))})
