...
public class Socket extends haxe.lang.HxObject
{
	...
	public static void __hx_ctor_sys_net_Socket(sys.net.Socket __hx_this)
	{
	...
	{
		//line 152 "/usr/share/haxe/std/java/_std/sys/net/Socket.hx"
		try 
		{
			//line 152 "/usr/share/haxe/std/java/_std/sys/net/Socket.hx"
		...
		catch (java.lang.Throwable __temp_catchallException1)
		{
			//line 152 "/usr/share/haxe/std/java/_std/sys/net/Socket.hx"
			haxe.lang.Exceptions.setException(__temp_catchallException1);
			//line 153 "/usr/share/haxe/std/java/_std/sys/net/Socket.hx"
			java.lang.Object __temp_catchall2 = __temp_catchallException1;
			//line 153 "/usr/share/haxe/std/java/_std/sys/net/Socket.hx"
			if (( __temp_catchall2 instanceof haxe.lang.HaxeException )) 
			{
