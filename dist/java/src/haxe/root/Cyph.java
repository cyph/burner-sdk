...
public class Cyph extends haxe.lang.HxObject
{
	static
	{
		...
		haxe.root.Cyph.services = new haxe.lang.DynamicObject(new java.lang.String[]{"backend", "chat", "video", "voice"}, new java.lang.Object[]{"https://api.cyph.com", "https://cyph.im/#", "https://cyph.video/#", "https://cyph.audio/#"}, new java.lang.String[]{}, new double[]{});
		//line 26 "/cyph/Cyph.hx"
	...
	public static java.lang.Object generateLink(haxe.root.Array<java.lang.Object> options, java.lang.Object services)
	{
		...
		//line 135 "/cyph/Cyph.hx"
		{
			...
			java.lang.String __temp_odecl1 = ( ( ( ( ( (( (( options.indexOf(((int) (haxe.lang.Runtime.getField_f(haxe.root.Cyph.options, "video", true)) ), null) > -1 )) ? (haxe.lang.Runtime.toString(haxe.lang.Runtime.getField(haxe.root.Cyph.services, "video", true))) : (( (( options.indexOf(((int) (haxe.lang.Runtime.getField_f(haxe.root.Cyph.options, "voice", true)) ), null) > -1 )) ? (haxe.lang.Runtime.toString(haxe.lang.Runtime.getField(haxe.root.Cyph.services, "voice", true))) : (haxe.lang.Runtime.toString(haxe.lang.Runtime.getField(haxe.root.Cyph.services, "chat", true))) )) )) + (( (( options.indexOf(((int) (haxe.lang.Runtime.getField_f(haxe.root.Cyph.options, "modestBranding", true)) ), null) > -1 )) ? ("&") : ("") )) ) + (( (( options.indexOf(((int) (haxe.lang.Runtime.getField_f(haxe.root.Cyph.options, "disableP2P", true)) ), null) > -1 )) ? ("$") : ("") )) ) + (( (( options.indexOf(((int) (haxe.lang.Runtime.getField_f(haxe.root.Cyph.options, "nativeCrypto", true)) ), null) > -1 )) ? ("%") : ("") )) ) + id ) + haxe.root.Cyph.generateGuid(19) );
			//line 135 "/cyph/Cyph.hx"
