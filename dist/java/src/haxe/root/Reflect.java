...
public class Reflect extends haxe.lang.HxObject
{
	...
	{
		//line 32 "/usr/share/haxe/std/java/_std/Reflect.hx"
		...
		//line 35 "/usr/share/haxe/std/java/_std/Reflect.hx"
	...
	{
		//line 40 "/usr/share/haxe/std/java/_std/Reflect.hx"
		if (( o instanceof haxe.lang.IHxObject )) 
		{
		...
		//line 43 "/usr/share/haxe/std/java/_std/Reflect.hx"
	...
	{
		//line 48 "/usr/share/haxe/std/java/_std/Reflect.hx"
		if (( o instanceof haxe.lang.IHxObject )) 
		{
	...
	{
		//line 57 "/usr/share/haxe/std/java/_std/Reflect.hx"
		if (( o instanceof haxe.lang.IHxObject )) 
		{
			//line 58 "/usr/share/haxe/std/java/_std/Reflect.hx"
			return ((haxe.lang.IHxObject) (o) ).__hx_getField(field, false, false, true);
		}
		
		//line 60 "/usr/share/haxe/std/java/_std/Reflect.hx"
		if (haxe.lang.Runtime.slowHasField(o, ( "get_" + field ))) 
		{
			//line 61 "/usr/share/haxe/std/java/_std/Reflect.hx"
			return haxe.lang.Runtime.slowCallField(o, ( "get_" + field ), null);
		}
		
		//line 63 "/usr/share/haxe/std/java/_std/Reflect.hx"
		return haxe.lang.Runtime.slowGetField(o, field, false);
	}
	...
	{
		//line 68 "/usr/share/haxe/std/java/_std/Reflect.hx"
		if (( o instanceof haxe.lang.IHxObject )) 
		{
			//line 69 "/usr/share/haxe/std/java/_std/Reflect.hx"
			((haxe.lang.IHxObject) (o) ).__hx_setField(field, value, true);
		}
		else
		{
			//line 70 "/usr/share/haxe/std/java/_std/Reflect.hx"
			if (haxe.lang.Runtime.slowHasField(o, ( "set_" + field ))) 
			{
				//line 71 "/usr/share/haxe/std/java/_std/Reflect.hx"
				haxe.lang.Runtime.slowCallField(o, ( "set_" + field ), new haxe.root.Array(new java.lang.Object[]{value}));
			}
			else
			{
				//line 73 "/usr/share/haxe/std/java/_std/Reflect.hx"
				haxe.lang.Runtime.slowSetField(o, field, value);
			}
	...
	{
		//line 79 "/usr/share/haxe/std/java/_std/Reflect.hx"
	...
	{
		//line 97 "/usr/share/haxe/std/java/_std/Reflect.hx"
	...
	{
		//line 102 "/usr/share/haxe/std/java/_std/Reflect.hx"
	...
	public static boolean compareMethods(java.lang.Object f1, java.lang.Object f2)
	{
		...
		//line 111 "/usr/share/haxe/std/java/_std/Reflect.hx"
		if (( ( f1 instanceof haxe.lang.Closure ) && ( f2 instanceof haxe.lang.Closure ) )) 
		{
			...
			//line 113 "/usr/share/haxe/std/java/_std/Reflect.hx"
			haxe.lang.Closure f2c = ((haxe.lang.Closure) (f2) );
			//line 114 "/usr/share/haxe/std/java/_std/Reflect.hx"
			return ( haxe.lang.Runtime.refEq(f1c.obj, f2c.obj) && haxe.lang.Runtime.valEq(f1c.field, f2c.field) );
		}
		
		//line 116 "/usr/share/haxe/std/java/_std/Reflect.hx"
		return false;
	}
	...
	{
		//line 121 "/usr/share/haxe/std/java/_std/Reflect.hx"
	...
	{
		//line 125 "/usr/share/haxe/std/java/_std/Reflect.hx"
	...
	{
		//line 130 "/usr/share/haxe/std/java/_std/Reflect.hx"
	...
	{
		//line 135 "/usr/share/haxe/std/java/_std/Reflect.hx"
		...
		//line 136 "/usr/share/haxe/std/java/_std/Reflect.hx"
		{
			//line 136 "/usr/share/haxe/std/java/_std/Reflect.hx"
			int _g = 0;
			//line 136 "/usr/share/haxe/std/java/_std/Reflect.hx"
			...
			while (( _g < _g1.length ))
			{
				...
				//line 136 "/usr/share/haxe/std/java/_std/Reflect.hx"
				 ++ _g;
				//line 137 "/usr/share/haxe/std/java/_std/Reflect.hx"
				haxe.root.Reflect.setField(o2, f, haxe.root.Reflect.field(o, f));
			}
			
		}
		
		//line 138 "/usr/share/haxe/std/java/_std/Reflect.hx"
		return ((T) (o2) );
	}
	...
	{
		//line 144 "/usr/share/haxe/std/java/_std/Reflect.hx"
