...
public class List<T> extends haxe.lang.HxObject
{
	...
	public List()
	{
		//line 40 "/usr/share/haxe/std/List.hx"
	...
	{
		//line 41 "/usr/share/haxe/std/List.hx"
		__temp_me6.length = 0;
	}
	...
	{
		//line 27 "/usr/share/haxe/std/List.hx"
	...
	{
		//line 50 "/usr/share/haxe/std/List.hx"
		haxe.root.Array x = new haxe.root.Array(new java.lang.Object[]{item});
		//line 51 "/usr/share/haxe/std/List.hx"
		if (( this.h == null )) 
		{
			//line 52 "/usr/share/haxe/std/List.hx"
			this.h = x;
		}
		else
		{
		...
		this.q = x;
		//line 56 "/usr/share/haxe/std/List.hx"
		this.length++;
	}
	...
	public void push(T item)
	{
		...
		//line 73 "/usr/share/haxe/std/List.hx"
		this.length++;
	}
	...
	{
		//line 162 "/usr/share/haxe/std/List.hx"
