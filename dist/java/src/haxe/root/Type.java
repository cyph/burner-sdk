...
public class Type extends haxe.lang.HxObject
{
	...
	{
		//line 43 "/usr/share/haxe/std/java/_std/Type.hx"
		...
		//line 46 "/usr/share/haxe/std/java/_std/Type.hx"
	...
	public static java.lang.Class getEnum(java.lang.Object o)
	{
		...
		{
			//line 52 "/usr/share/haxe/std/java/_std/Type.hx"
			return o.getClass();
		}
		
		//line 54 "/usr/share/haxe/std/java/_std/Type.hx"
		return null;
	}
	...
	{
		//line 59 "/usr/share/haxe/std/java/_std/Type.hx"
		java.lang.Class c1 = ((java.lang.Class) (c) );
		//line 60 "/usr/share/haxe/std/java/_std/Type.hx"
		...
		//line 61 "/usr/share/haxe/std/java/_std/Type.hx"
		...
		{
			//line 62 "/usr/share/haxe/std/java/_std/Type.hx"
			return ((java.lang.Class) (cl) );
		}
		
		//line 64 "/usr/share/haxe/std/java/_std/Type.hx"
		return null;
	}
	...
	{
		//line 68 "/usr/share/haxe/std/java/_std/Type.hx"
		java.lang.Class c1 = ((java.lang.Class) (c) );
		//line 69 "/usr/share/haxe/std/java/_std/Type.hx"
		java.lang.String name = c1.getName();
		//line 70 "/usr/share/haxe/std/java/_std/Type.hx"
		if (name.startsWith("haxe.root.")) 
		{
			//line 71 "/usr/share/haxe/std/java/_std/Type.hx"
			return haxe.lang.StringExt.substr(name, 10, null);
		}
		
		//line 72 "/usr/share/haxe/std/java/_std/Type.hx"
		if (name.startsWith("java.lang")) 
		{
			//line 73 "/usr/share/haxe/std/java/_std/Type.hx"
			name = haxe.lang.StringExt.substr(name, 10, null);
		}
		
		//line 75 "/usr/share/haxe/std/java/_std/Type.hx"
		{
			//line 75 "/usr/share/haxe/std/java/_std/Type.hx"
	...
	{
		//line 85 "/usr/share/haxe/std/java/_std/Type.hx"
		java.lang.Class c = ((java.lang.Class) (e) );
		//line 86 "/usr/share/haxe/std/java/_std/Type.hx"
		java.lang.String ret = c.getName();
		//line 87 "/usr/share/haxe/std/java/_std/Type.hx"
		if (ret.startsWith("haxe.root.")) 
		{
			//line 88 "/usr/share/haxe/std/java/_std/Type.hx"
			return haxe.lang.StringExt.substr(ret, 10, null);
		}
		else
		{
			//line 89 "/usr/share/haxe/std/java/_std/Type.hx"
			if (( haxe.lang.Runtime.valEq(ret, "boolean") || haxe.lang.Runtime.valEq(ret, "java.lang.Boolean") )) 
			{
				//line 90 "/usr/share/haxe/std/java/_std/Type.hx"
				return "Bool";
			}
			
		}
		
		//line 92 "/usr/share/haxe/std/java/_std/Type.hx"
		return ret;
	}
	...
	{
		//line 97 "/usr/share/haxe/std/java/_std/Type.hx"
		try 
		{
			//line 98 "/usr/share/haxe/std/java/_std/Type.hx"
			if (( haxe.lang.StringExt.indexOf(name, ".", null) == -1 )) 
			{
				//line 99 "/usr/share/haxe/std/java/_std/Type.hx"
				name = ( "haxe.root." + name );
			}
			
			//line 101 "/usr/share/haxe/std/java/_std/Type.hx"
			return ((java.lang.Class) (java.lang.Class.forName(haxe.lang.Runtime.toString(name))) );
		}
		catch (java.lang.ClassNotFoundException e)
		{
			//line 103 "/usr/share/haxe/std/java/_std/Type.hx"
	...
	{
		//line 248 "/usr/share/haxe/std/java/_std/Type.hx"
		if (haxe.root.Reflect.hasField(cl, "__hx_createEmpty")) 
		{
			//line 249 "/usr/share/haxe/std/java/_std/Type.hx"
			return ((T) (haxe.lang.Runtime.callField(cl, "__hx_createEmpty", null)) );
		}
		
		//line 250 "/usr/share/haxe/std/java/_std/Type.hx"
	...
	{
		//line 270 "/usr/share/haxe/std/java/_std/Type.hx"
		haxe.root.Array<java.lang.String> constr = haxe.root.Type.getEnumConstructs(e);
		//line 271 "/usr/share/haxe/std/java/_std/Type.hx"
	...
	{
		//line 334 "/usr/share/haxe/std/java/_std/Type.hx"
		if (haxe.root.Reflect.hasField(e, "__hx_constructs")) 
		{
			//line 336 "/usr/share/haxe/std/java/_std/Type.hx"
			...
			//line 337 "/usr/share/haxe/std/java/_std/Type.hx"
			return ret.copy();
		}
		
		//line 339 "/usr/share/haxe/std/java/_std/Type.hx"
		...
		//line 340 "/usr/share/haxe/std/java/_std/Type.hx"
		{
			//line 340 "/usr/share/haxe/std/java/_std/Type.hx"
			int _g1 = 0;
			//line 340 "/usr/share/haxe/std/java/_std/Type.hx"
			...
			while (( _g1 < _g ))
			{
				//line 340 "/usr/share/haxe/std/java/_std/Type.hx"
				int i = _g1++;
				//line 341 "/usr/share/haxe/std/java/_std/Type.hx"
				ret1.__set(i, vals[i].name());
			}
			
		}
		
		//line 342 "/usr/share/haxe/std/java/_std/Type.hx"
		return ret1;
	}
	...
	public static <T> haxe.root.Array<T> allEnums(java.lang.Class e)
	{
		...
		//line 423 "/usr/share/haxe/std/java/_std/Type.hx"
		{
			...
			while (( _g < ctors.length ))
			{
				...
				//line 423 "/usr/share/haxe/std/java/_std/Type.hx"
				 ++ _g;
				//line 425 "/usr/share/haxe/std/java/_std/Type.hx"
				T v = ((T) (haxe.root.Reflect.field(e, ctor)) );
				//line 426 "/usr/share/haxe/std/java/_std/Type.hx"
				if (haxe.root.Std.is(v, e)) 
				{
					//line 427 "/usr/share/haxe/std/java/_std/Type.hx"
					ret.push(v);
				}
		...
		//line 430 "/usr/share/haxe/std/java/_std/Type.hx"
		return ret;
	}
