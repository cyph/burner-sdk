...
public final class Array<T> extends haxe.lang.HxObject
{
	...
	public Array()
	{
		//line 54 "/usr/share/haxe/std/java/_std/Array.hx"
	...
	{
		//line 56 "/usr/share/haxe/std/java/_std/Array.hx"
		__temp_me1.length = 0;
		//line 57 "/usr/share/haxe/std/java/_std/Array.hx"
	...
	{
		//line 32 "/usr/share/haxe/std/java/_std/Array.hx"
	...
	{
		//line 73 "/usr/share/haxe/std/java/_std/Array.hx"
		T[] __a = this.__a;
		//line 74 "/usr/share/haxe/std/java/_std/Array.hx"
		int length = this.length;
		...
		else
		{
			...
			//line 84 "/usr/share/haxe/std/java/_std/Array.hx"
			this.__a = newarr;
		}
	...
	public final java.lang.String join(java.lang.String sep)
	{
		...
		int length = this.length;
		//line 97 "/usr/share/haxe/std/java/_std/Array.hx"
		while ((  ++ i < length ))
		{
			//line 99 "/usr/share/haxe/std/java/_std/Array.hx"
			if (first) 
			{
				//line 100 "/usr/share/haxe/std/java/_std/Array.hx"
				first = false;
			}
			else
			{
	...
	public final java.lang.Object pop()
	{
		...
		if (( length > 0 )) 
		{
			...
			__a[length] = null;
			//line 117 "/usr/share/haxe/std/java/_std/Array.hx"
			this.length = length;
	...
	public final int push(T x)
	{
		...
		{
			//line 130 "/usr/share/haxe/std/java/_std/Array.hx"
			int newLen = ( (( length << 1 )) + 1 );
			//line 131 "/usr/share/haxe/std/java/_std/Array.hx"
			T[] newarr = ((T[]) (((java.lang.Object) (new java.lang.Object[newLen]) )) );
			//line 132 "/usr/share/haxe/std/java/_std/Array.hx"
	...
	public final void reverse()
	{
		...
		int l = this.length;
		//line 145 "/usr/share/haxe/std/java/_std/Array.hx"
		T[] a = this.__a;
		//line 146 "/usr/share/haxe/std/java/_std/Array.hx"
		int half = ( l >> 1 );
	...
	{
		//line 159 "/usr/share/haxe/std/java/_std/Array.hx"
		int l = this.length;
		//line 160 "/usr/share/haxe/std/java/_std/Array.hx"
		if (( l == 0 )) 
		{
	...
	{
		//line 175 "/usr/share/haxe/std/java/_std/Array.hx"
		if (( pos < 0 )) 
		{
	...
	{
		//line 197 "/usr/share/haxe/std/java/_std/Array.hx"
		if (( this.length == 0 )) 
		{
	...
	{
		//line 225 "/usr/share/haxe/std/java/_std/Array.hx"
		if (( len < 0 )) 
		{
			//line 225 "/usr/share/haxe/std/java/_std/Array.hx"
			return new haxe.root.Array<T>();
	...
	public final void spliceVoid(int pos, int len)
	{
		...
		//line 254 "/usr/share/haxe/std/java/_std/Array.hx"
		if (( pos < 0 )) 
		{
			//line 255 "/usr/share/haxe/std/java/_std/Array.hx"
			pos = ( this.length + pos );
	...
	@Override public java.lang.String toString()
	{
		...
		ret.add("[");
		//line 279 "/usr/share/haxe/std/java/_std/Array.hx"
		boolean first = true;
		//line 280 "/usr/share/haxe/std/java/_std/Array.hx"
		{
			//line 280 "/usr/share/haxe/std/java/_std/Array.hx"
			int _g1 = 0;
			//line 280 "/usr/share/haxe/std/java/_std/Array.hx"
	...
	{
		//line 295 "/usr/share/haxe/std/java/_std/Array.hx"
		T[] __a = this.__a;
	...
	public final void insert(int pos, T x)
	{
		...
		else
		{
			...
			if (( pos == 0 )) 
			{
				...
				this.unshift(x);
				//line 324 "/usr/share/haxe/std/java/_std/Array.hx"
				return ;
			}
		...
		{
			//line 329 "/usr/share/haxe/std/java/_std/Array.hx"
	...
	public final boolean remove(T x)
	{
		...
		//line 362 "/usr/share/haxe/std/java/_std/Array.hx"
		return false;
	}
	...
	public final int indexOf(T x, java.lang.Object fromIndex)
	{
		...
		while (( i < len ))
		{
			//line 374 "/usr/share/haxe/std/java/_std/Array.hx"
		...
		//line 378 "/usr/share/haxe/std/java/_std/Array.hx"
		return -1;
	}
	...
	public final int lastIndexOf(T x, java.lang.Object fromIndex)
	{
		...
		while (( i >= 0 ))
		{
			//line 389 "/usr/share/haxe/std/java/_std/Array.hx"
			if (haxe.lang.Runtime.eq(a[i], x)) 
			{
	...
	{
		//line 407 "/usr/share/haxe/std/java/_std/Array.hx"
	...
	public final haxe.root.Array<T> filter(haxe.lang.Function f)
	{
		...
		//line 419 "/usr/share/haxe/std/java/_std/Array.hx"
		{
			//line 419 "/usr/share/haxe/std/java/_std/Array.hx"
			int _g = 0;
			//line 419 "/usr/share/haxe/std/java/_std/Array.hx"
			...
			while (( _g < _g1.length ))
			{
				...
				//line 419 "/usr/share/haxe/std/java/_std/Array.hx"
				 ++ _g;
				//line 420 "/usr/share/haxe/std/java/_std/Array.hx"
				if (haxe.lang.Runtime.toBool(f.__hx_invoke1_o(0.0, elt))) 
				{
					//line 421 "/usr/share/haxe/std/java/_std/Array.hx"
					ret.push(elt);
				}
	...
	public final T __get(int idx)
	{
		...
		T[] __a = this.__a;
		//line 428 "/usr/share/haxe/std/java/_std/Array.hx"
	...
	public final T __set(int idx, T v)
	{
		...
		//line 448 "/usr/share/haxe/std/java/_std/Array.hx"
		if (( idx >= this.length )) 
		{
		...
		//line 451 "/usr/share/haxe/std/java/_std/Array.hx"
		return __a[idx] = v;
	}
	...
	{
		//line 456 "/usr/share/haxe/std/java/_std/Array.hx"
		return this.__a[idx];
	}
