...
public class FieldLookup extends haxe.lang.HxObject
{
	...
	public FieldLookup()
	{
		//line 28 "/usr/share/haxe/std/java/internal/FieldLookup.hx"
		haxe.lang.FieldLookup.__hx_ctor_haxe_lang_FieldLookup(this);
	}
	
	
	public static void __hx_ctor_haxe_lang_FieldLookup(haxe.lang.FieldLookup __temp_me17)
	{
	}
	...
	public static int findHash(java.lang.String hash, java.lang.String[] hashs, int length)
	{
		...
		while (( min < max ))
		{
			...
			//line 48 "/usr/share/haxe/std/java/internal/FieldLookup.hx"
			if (( classify < 0 )) 
			{
				//line 50 "/usr/share/haxe/std/java/internal/FieldLookup.hx"
				max = mid;
			}
			else
			{
				//line 51 "/usr/share/haxe/std/java/internal/FieldLookup.hx"
				if (( classify > 0 )) 
				{
					//line 52 "/usr/share/haxe/std/java/internal/FieldLookup.hx"
					min = ( mid + 1 );
				}
				else
				{
					//line 54 "/usr/share/haxe/std/java/internal/FieldLookup.hx"
					return mid;
				}
	...
	{
		//line 72 "/usr/share/haxe/std/java/internal/FieldLookup.hx"
		java.lang.System.arraycopy(((java.lang.Object) (a) ), ((int) (( pos + 1 )) ), ((java.lang.Object) (a) ), ((int) (pos) ), ((int) (( ( length - pos ) - 1 )) ));
		//line 73 "/usr/share/haxe/std/java/internal/FieldLookup.hx"
		a[( length - 1 )] = null;
	}
	...
	{
		//line 121 "/usr/share/haxe/std/java/internal/FieldLookup.hx"
		{
			//line 121 "/usr/share/haxe/std/java/internal/FieldLookup.hx"
	...
	{
		//line 122 "/usr/share/haxe/std/java/internal/FieldLookup.hx"
		{
			//line 122 "/usr/share/haxe/std/java/internal/FieldLookup.hx"
			double[] a1 = a;
			//line 122 "/usr/share/haxe/std/java/internal/FieldLookup.hx"
	...
	{
		//line 123 "/usr/share/haxe/std/java/internal/FieldLookup.hx"
		{
			//line 123 "/usr/share/haxe/std/java/internal/FieldLookup.hx"
