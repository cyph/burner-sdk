...
public class DynamicObject extends haxe.lang.HxObject
{
	...
	{
		//line 47 "/usr/share/haxe/std/java/internal/HxObject.hx"
		haxe.lang.Function ts = ((haxe.lang.Function) (haxe.lang.Runtime.getField(this, "toString", false)) );
		//line 48 "/usr/share/haxe/std/java/internal/HxObject.hx"
		if (( ts != null )) 
		{
			//line 49 "/usr/share/haxe/std/java/internal/HxObject.hx"
		...
		//line 51 "/usr/share/haxe/std/java/internal/HxObject.hx"
		ret.add("{");
		...
		//line 53 "/usr/share/haxe/std/java/internal/HxObject.hx"
		{
			...
			while (( _g < _g1.length ))
			{
				...
				{
					//line 58 "/usr/share/haxe/std/java/internal/HxObject.hx"
					ret.add(",");
				}
