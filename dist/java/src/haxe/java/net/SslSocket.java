...
public class SslSocket extends sys.net.Socket
{
	...
	public static void __hx_ctor_haxe_java_net_SslSocket(haxe.java.net.SslSocket __temp_me34)
	{
		//line 37 "/usr/share/haxe/std/java/_std/sys/net/Socket.hx"
		sys.net.Socket.__hx_ctor_sys_net_Socket(__temp_me34);
	}
	...
	{
		//line 24 "/usr/share/haxe/std/java/net/SslSocket.hx"
		return new haxe.java.net.SslSocket(haxe.lang.EmptyObject.EMPTY);
	}
