...
public class NativeInput extends haxe.io.Input
{
	...
	{
		//line 30 "/usr/share/haxe/std/java/io/NativeInput.hx"
	...
	{
		//line 33 "/usr/share/haxe/std/java/io/NativeInput.hx"
	...
	@Override public int readByte()
	{
		...
		int ret = 0;
		//line 43 "/usr/share/haxe/std/java/io/NativeInput.hx"
		try 
		{
			//line 43 "/usr/share/haxe/std/java/io/NativeInput.hx"
		...
		if (( ret == -1 )) 
		{
			//line 49 "/usr/share/haxe/std/java/io/NativeInput.hx"
			throw haxe.lang.HaxeException.wrap(new haxe.io.Eof());
		}
		
		//line 50 "/usr/share/haxe/std/java/io/NativeInput.hx"
		return ret;
	}
	...
	{
		//line 55 "/usr/share/haxe/std/java/io/NativeInput.hx"
		int ret = 0;
		//line 58 "/usr/share/haxe/std/java/io/NativeInput.hx"
		try 
		{
			//line 58 "/usr/share/haxe/std/java/io/NativeInput.hx"
		...
		{
			//line 66 "/usr/share/haxe/std/java/io/NativeInput.hx"
		...
		//line 69 "/usr/share/haxe/std/java/io/NativeInput.hx"
		if (( ret == -1 )) 
		{
			//line 70 "/usr/share/haxe/std/java/io/NativeInput.hx"
			throw haxe.lang.HaxeException.wrap(new haxe.io.Eof());
		}
		
		//line 71 "/usr/share/haxe/std/java/io/NativeInput.hx"
		return ret;
	}
