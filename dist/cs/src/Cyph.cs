...
public class Cyph : global::haxe.lang.HxObject {
	...
	public static void initiateSession(string apiKey, global::Array<int> options, global::haxe.lang.Function onData, global::haxe.lang.Function onError) {
		unchecked {
			...
			string cyphUrl = global::haxe.lang.Runtime.concat(global::haxe.lang.Runtime.concat(global::haxe.lang.Runtime.concat(global::haxe.lang.Runtime.concat(global::haxe.lang.Runtime.concat(global::haxe.lang.Runtime.concat(global::haxe.lang.Runtime.concat("https://", (( (( options.indexOf(((int) (global::haxe.lang.Runtime.getField_f(global::Cyph.options, "video", 922489979, true)) ), default(global::haxe.lang.Null<int>)) > -1 )) ? (global::haxe.lang.Runtime.toString(global::haxe.lang.Runtime.getField(global::Cyph.services, "video", 922489979, true))) : (( (( options.indexOf(((int) (global::haxe.lang.Runtime.getField_f(global::Cyph.options, "voice", 989275570, true)) ), default(global::haxe.lang.Null<int>)) > -1 )) ? (global::haxe.lang.Runtime.toString(global::haxe.lang.Runtime.getField(global::Cyph.services, "voice", 989275570, true))) : (global::haxe.lang.Runtime.toString(global::haxe.lang.Runtime.getField(global::Cyph.services, "chat", 1103060696, true))) )) ))), "/#"), (( (( options.indexOf(((int) (global::haxe.lang.Runtime.getField_f(global::Cyph.options, "modestBranding", 1145895711, true)) ), default(global::haxe.lang.Null<int>)) > -1 )) ? ("&") : ("") ))), (( (( options.indexOf(((int) (global::haxe.lang.Runtime.getField_f(global::Cyph.options, "disableP2P", 916821830, true)) ), default(global::haxe.lang.Null<int>)) > -1 )) ? ("$") : ("") ))), (( (( options.indexOf(((int) (global::haxe.lang.Runtime.getField_f(global::Cyph.options, "nativeCrypto", 1047139896, true)) ), default(global::haxe.lang.Null<int>)) > -1 )) ? ("%") : ("") ))), cyphId), global::Cyph.generateGuid(19));
			global::Cyph.request("https://api.cyph.com/preauth", true, new global::Array<object>(new object[]{new global::haxe.lang.DynamicObject(new int[]{107, 118}, new object[]{"apiKey", apiKey}, new int[]{}, new double[]{}), new global::haxe.lang.DynamicObject(new int[]{107, 118}, new object[]{"id", cyphId}, new int[]{}, new double[]{})}), new global::Cyph_initiateSession_143__Fun(onData, cyphUrl), onError);
		}
	}
...
#pragma warning disable 109, 114, 219, 429, 168, 162
public class Cyph_initiateSession_143__Fun : global::haxe.lang.Function {
	
	public Cyph_initiateSession_143__Fun(global::haxe.lang.Function onData, string cyphUrl) : base(1, 0) {
		this.onData = onData;
