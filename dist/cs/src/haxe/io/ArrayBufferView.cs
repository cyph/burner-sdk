...
namespace haxe.io {
	public class ArrayBufferViewImpl : global::haxe.lang.HxObject {
		...
		public static void __hx_ctor_haxe_io_ArrayBufferViewImpl(global::haxe.io.ArrayBufferViewImpl __hx_this, global::haxe.io.Bytes bytes, int pos, int length) {
...
namespace haxe.io._ArrayBufferView {
	public sealed class ArrayBufferView_Impl_ {
		...
		public static global::haxe.io.ArrayBufferViewImpl fromBytes(global::haxe.io.Bytes bytes, global::haxe.lang.Null<int> pos, global::haxe.lang.Null<int> length) {
			int __temp_pos7 = ( ( ! (pos.hasValue) ) ? (0) : ((pos).@value) );
			if ( ! (length.hasValue) ) {
				length = new global::haxe.lang.Null<int>(( bytes.length - __temp_pos7 ), true);
			}
			
			if (( ( ( __temp_pos7 < 0 ) || ( (length).@value < 0 ) ) || ( ( __temp_pos7 + (length).@value ) > bytes.length ) )) {
				throw global::haxe.lang.HaxeException.wrap(global::haxe.io.Error.OutsideBounds);
			}
			
			return ((global::haxe.io.ArrayBufferViewImpl) (new global::haxe.io.ArrayBufferViewImpl(bytes, __temp_pos7, (length).@value)) );
		}
