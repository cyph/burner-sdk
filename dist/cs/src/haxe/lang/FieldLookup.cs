...
namespace haxe.lang {
	public sealed class FieldLookup {
		...
		protected static int[] fieldIds = new int[]{98, 105, 4745537, 4849249, 5393365, 5442204, 5594513, 76061764, 87367608, 328878574, 359333139, 407283053, 452737314, 501039929, 520590566, 916821830, 922489979, 946786476, 989275570, 1047139896, 1067353468, 1103060696, 1103412149, 1136381571, 1145895711, 1181037546, 1204816148, 1224901875, 1247875546, 1280845662, 1282943179, 1352786672, 1532710347, 1620824029, 1621420777, 1623148745, 1705629508, 1781145963, 1915412854, 1916009602, 2025055113, 2082663554, 2084789794, 2127021138};
		
		protected static string[] fields = new string[]{"b", "i", "__a", "arr", "len", "map", "pop", "remove", "filter", "iterator", "lastIndexOf", "hasNext", "reverse", "insert", "length", "disableP2P", "video", "toString", "voice", "nativeCrypto", "splice", "chat", "copy", "fill", "modestBranding", "join", "concat", "next", "push", "sort", "quicksort", "spliceVoid", "concatNative", "__unsafe_get", "__unsafe_set", "indexOf", "toDynamic", "__hx_constructs", "__get", "__set", "unshift", "shift", "__hx_createEmpty", "slice"};
