...
namespace haxe.lang {
	public sealed class FieldLookup {
		...
		protected static int[] fieldIds = new int[]{98, 104, 105, 107, 109, 113, 118, 23515, 23526, 1821933, 4745537, 4846113, 4849249, 4949376, 5393365, 5442204, 5594513, 5594516, 5741474, 5745024, 5843823, 10663594, 52644165, 57476627, 76061764, 87367608, 142301684, 157772329, 159136996, 179047623, 209784577, 243225909, 288167040, 305151978, 328878574, 359333139, 360725482, 380244791, 400509660, 407283053, 452737314, 480756972, 493819893, 501039929, 520590566, 610723709, 640252688, 660670753, 735461151, 834174833, 916821830, 922489979, 922671056, 937267591, 943988923, 946786476, 989275570, 995006396, 1029013645, 1033373803, 1042138122, 1047139896, 1058556349, 1067353468, 1103060696, 1103412149, 1136381564, 1136381571, 1137315269, 1145895711, 1149558607, 1156121931, 1158359328, 1158860648, 1170195731, 1181037546, 1196428959, 1202919418, 1204816148, 1214453688, 1224901875, 1228056441, 1238832007, 1247576961, 1247875546, 1271070480, 1280549057, 1280842308, 1280845662, 1282943179, 1309344294, 1313416818, 1348037855, 1352786672, 1381630732, 1395555037, 1398464674, 1431819701, 1436822557, 1488620307, 1532710347, 1533657591, 1537812987, 1554480847, 1560893070, 1620824029, 1621420777, 1623148745, 1631774278, 1661489734, 1693277929, 1705565617, 1705629508, 1723805383, 1763375486, 1768617329, 1795947670, 1828713895, 1836776262, 1855145886, 1915412854, 1916009602, 1970444429, 1987394228, 1997282830, 2003447495, 2022294396, 2025055113, 2048392659, 2054707467, 2082663554, 2097154445, 2127021138};
		
		protected static string[] fields = new string[]{"b", "h", "i", "k", "m", "q", "v", "id", "io", "isGlobal", "__a", "add", "arr", "cur", "len", "map", "pop", "pos", "set", "sub", "url", "postData", "match", "getEnumConstructs", "remove", "filter", "resize", "onError", "matched", "readString", "output", "readBytes", "stream", "hostEntry", "iterator", "lastIndexOf", "connect", "readChunk", "totlen", "hasNext", "reverse", "nOccupied", "getBytes", "insert", "length", "writeFullBytes", "writeString", "chunk_buf", "setTimeout", "value", "disableP2P", "video", "cachedIndex", "prepare", "byteOffset", "toString", "voice", "hashes", "param", "bytes", "input", "nativeCrypto", "_eof", "splice", "chat", "copy", "file", "fill", "responseHeaders", "modestBranding", "request", "responseData", "head", "host", "item", "join", "readHttpResponse", "link", "concat", "close", "next", "enumConstructor", "writeByte", "port", "push", "matchedPos", "size", "sock", "sort", "quicksort", "readFullBytes", "vals", "write", "spliceVoid", "writeBytes", "cachedKey", "getEnumName", "createEnumIndex", "createEnum", "chunk_size", "concatNative", "noShutdown", "nBuckets", "setHeader", "mimeType", "__unsafe_get", "__unsafe_set", "indexOf", "telehealth", "headers", "onData", "onStatus", "toDynamic", "regex", "readByte", "allEnums", "shutdown", "setParameter", "params", "customRequest", "__get", "__set", "ipAddress", "cnxTimeout", "byteLength", "filename", "upperBound", "unshift", "_keys", "enumParameters", "shift", "header", "slice"};
