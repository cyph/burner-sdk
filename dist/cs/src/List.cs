...
namespace _List {
	public class ListIterator<T> : global::haxe.lang.HxObject, global::_List.ListIterator {
		...
		public static void __hx_ctor__List_ListIterator<T_c>(global::_List.ListIterator<T_c> __hx_this, global::_List.ListNode<T_c> head) {
			__hx_this.head = head;
		}
		
		
		public static object __hx_cast<T_c_c>(global::_List.ListIterator me) {
			return ( (( me != null )) ? (me._List_ListIterator_cast<T_c_c>()) : default(object) );
		}
